...
export class Stock {
  baseProduct = [
    ...
    { id: 21, name: "กางเกงขายาว", category: "เสื้อผ้า", descript: "Lorem ipsum dolor sit amet", price: 200, quantity: 0 },
    { id: 22, name: "ผัดกะเพราหมูกรอบ", category: "อาหาร", descript: "Lorem ipsum dolor sit amet", price: 50, quantity: 0 },
